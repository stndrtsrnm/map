...
async function loadCities() {
    ...
    try {
        ...
        // Фильтруем и сортируем по населению
        cities = cities
...
// Добавляем города в виде окружностей
function addCitiesToMap(cities) {
    const features = cities.map(city => ({
        ...
        properties: {
            ...
            radius: city.population * 0.000005 // ✅ Формула размера круга
        }
    }));
